            ...
            <nav className="relative h-full">
                ...
                <div className="md:px-4 flex h-full items-center gap-x-4 px-3.5">
                    ...
                    <div className="ml-auto flex gap-x-4 items-center">
                        <a href="/innovation" className="text-sm font-semibold leading-6 text-white hover:text-[#00934b] transition-colors">
                            Innovation
                        </a>
                        <a href="https://github.com/cswasif/zks" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors">
